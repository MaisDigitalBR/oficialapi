...
//
// Source: https://github.com/MaisDigitalBR/metaoficialapi
...
export const SOURCE_URL = (env("SOURCE_URL") || "https://github.com/MaisDigitalBR/metaoficialapi").replace(/\/$/, "");
