...
(function () {
  ...
  function applyPromo() {
    ...
    var lf = $("loginFoot"); if (lf) lf.innerHTML = t("login.tool", { hub_l: ytLink });
    var ad = $("aboutDesc"); if (ad) ad.innerHTML = t("config.aboutDesc", { hub_l: ytLink });
    var fo = $("footerOffered"); if (fo) fo.innerHTML = t("footer.offered", { hub_l: ytPlain });
  }
  ...
  function renderSidePanel() {
    ...
    if (hasApp && hasVerify && hasChannel) {
      box.innerHTML =
        ...
        '<a href="' + ZP_URL + '" target="_blank" rel="noopener" aria-label="Smartzap"><img class="logo-light" src="/assets/logo.png" alt="Smartzap" style="margin:.2rem 0 .85rem" /></a>' +
        ...
        '<div class="side-cta">' +
          ...
          '<a class="btn secondary" href="' + ZP_URL + '" target="_blank" rel="noopener">' + esc(t("hero.know")) + "</a>" +
        "</div>";
      return;
    }
  ...
  function embedSnippet(appId, channel) {
    ...
    return '<a href="' + url + '" target="_blank" rel="noopener" ' +
      "onclick=\"window.open(this.href,'hub_connect','width=560,height=740');return false;\" " +
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    document.addEventListener("click", function (e) {
      ...
      if (tb) { var w = window.open(tb.getAttribute("data-embed-test"), "hub_connect", "width=560,height=740"); if (!w) toast(t("embed.popupBlocked"), true); return; }
