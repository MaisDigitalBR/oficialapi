...
> Projeto gratuito da **Mais digital** · conheça o **[Smartzap](https://maisdigitalbr.com/smartzap)**.
...
git clone https://github.com/MaisDigitalBR/metaoficialapi.git && cd oauth-hub
...
```bash
cd oauth-hub              # ou extra/oauth-hub no monorepo
...
(`SOURCE_URL`, padrão [https://github.com/MaisDigitalBR/metaoficialapi](https://github.com/MaisDigitalBR/metaoficialapi)). Se você
